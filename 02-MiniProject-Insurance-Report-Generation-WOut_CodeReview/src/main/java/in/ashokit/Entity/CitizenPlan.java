...
//this class is to set all Fields in database

@Entity
public class CitizenPlan {
	@Id										
	@GeneratedValue(strategy = GenerationType.IDENTITY) //MYSQL-IDENTITY  for ORACEL-SEQUENCE used
	...
	/* we are not inserting/updating data so skip
	 * private LocalDate createDate; private LocalDate updateDate;
	 */
	...
	//this constructor initialize data
